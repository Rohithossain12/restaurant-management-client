  ...
  return (
    <div className=" bg-[#6A1B9A]  ">
      <footer className="container mx-auto footer p-10 text-white ">
        <aside>
          <h3 className="text-lg lg:text-3xl md:text-2xl font-bold">
          ...
          <p className="text-center">
            <span className="text-[#FFC107] font-bold">Food</span>{" "}
            <span>
              <span className=" font-bold">&</span>{" "}
            </span>
            <span className="text-[#FF5722]  font-bold">Drinks</span>
          </p>
        </aside>
        <nav>
          ...
          <a className="link link-hover">Takeout Options</a>
        </nav>
        <nav>
          ...
          <a className="link link-hover">Media Inquiries</a>
        </nav>
        <nav>
